// DX11 shader 0xE6DB4236, decompiled from the matching 1.4.4 game shader dump.
#include "../shared.h"

// ---- Created with 3Dmigoto v1.3.16 on Fri Aug 21 02:45:40 2026
...
// Decompiler repair: restore the vanilla typed UAV declarations.
...
// Decompiler repair: restore the vanilla compute dispatch semantics.
[numthreads(8, 8, 1)]
void main(
  ...
  uint3 vThreadGroupID : SV_GroupID)
{
  ...
  r0.x = t0[vThreadGroupID.x].val[0/4];
  r1.x = (uint)r0.x >> 16;
  r1.y = (int)r0.x & 0x0000ffff;
  ...
  if (r1.x == 0) {
    /*
    Decompiled vanilla instruction:
    ld_uav_typed_indexable(texture2d)(unorm,unorm,unorm,unorm) r1.x, r0.xyyy, u2.xyzw
    */
    // Decompiler repair: restore the vanilla history-mask load.
    ...
    if (r1.w != 0) {
      ...
      r1.w = t5.SampleLevel(s0_s, r2.zw, 0).x;
      r1.w = cmp(0.5 < r1.w);
      // RenoDX code: Remember which pixels use the full trace budget.
      bool renodx_full_trace = r1.w != 0;
      r2.z = cb2[3].x * 0.125;
      r2.z = ceil(r2.z);
      r2.z = max(4, r2.z);
      r1.w = r1.w ? cb2[3].x : r2.z;
      // RenoDX code: Raise ray-step floors for more stable long reflections.
      if (shader_injection.improved_ssr >= 0.5f) {
        r1.w = max(r1.w, renodx_full_trace ? 256.0f : 32.0f);
      }
      r3.z = t3.SampleLevel(s0_s, r2.xy, 0).x;
      ...
      r1.y = t3.SampleLevel(s0_s, r6.xy, 0).x;
      r1.y = r6.z + -r1.y;
      r7.xyz = float3(0,0,0);
      r8.xyz = float3(0,0,0);
      r9.xyz = r6.xyz;
      ...
      while (true) {
        ...
        if (r3.w != 0) {
          ...
          r13.x = t3.SampleLevel(s0_s, r10.xy, 0).x;
          r13.y = t3.SampleLevel(s0_s, r10.zw, 0).x;
          r13.z = t3.SampleLevel(s0_s, r11.xy, 0).x;
          r13.w = t3.SampleLevel(s0_s, r11.zw, 0).x;
      ...
      if (r1.z != 0) {
        ...
        r0.w = r1.y ? 1 : r0.w;
        r0.w = r1.x * r0.w;
        r1.yz = t4.SampleLevel(s0_s, r8.xy, 0).xy;
        ...
        r1.y = t2.SampleLevel(s0_s, r2.xy, 0).x;
        r1.z = cmp(0 < r1.y);
      ...
      r1.yz = t4.SampleLevel(s0_s, r2.xy, 0).xy;
      ...
      r0.w = r0.w / cb2[5].y;
      r4.y = r0.z ? 0 : r0.w;
      // RenoDX code: Tighten the temporal sharpness response when improved SSR is enabled.
      if (shader_injection.improved_ssr >= 0.5f) {
        r4.y = saturate((r4.y - 0.25f) / 0.75f);
      }
    } else {
      r4.xy = float2(0,0);
    }
    r1.yzw = t1.SampleLevel(s0_s, r2.xy, 0).xyz;
    r0.z = max(r1.y, r1.z);
    r0.z = max(r0.z, r1.w);
    r0.z = 1 + r0.z;
    r0.z = 1 / r0.z;
    r2.xyzw = r1.yzwy * r0.zzzz;
    /*
    Decompiled vanilla instruction:
    store_uav_typed u0.xyzw, r0.xyyy, r2.xyzw
    */
    // Decompiler repair: restore the vanilla typed UAV store.
    u0[(uint2)r0.xy] = r2.xyzw;
    /*
    Decompiled vanilla instruction:
    store_uav_typed u1.xyzw, r0.xyyy, r4.xyxx
    */
    // Decompiler repair: restore the vanilla typed UAV store.
    u1[(uint2)r0.xy] = r4.xyxx;
    /*
    Decompiled vanilla instruction:
    store_uav_typed u2.xyzw, r0.xyyy, r1.xxxx
    */
    // Decompiler repair: restore the vanilla typed UAV store.
