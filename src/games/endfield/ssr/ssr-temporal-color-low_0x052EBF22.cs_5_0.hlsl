// DX11 shader 0x052EBF22, decompiled from the matching 1.4.4 game shader dump.
#include "../shared.h"
  ...
  if (r1.x == 0) {
    ...
    */
    ...
    if (r1.w != 0) {
      ...
      r1.w = ceil(r1.w);
      r1.w = max(4, r1.w);
      // RenoDX code: Raise the low-resolution ray-step floor for more stable reflections.
