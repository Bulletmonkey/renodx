// DX11 shader 0x49E8BE54, decompiled from the matching 1.5 game shader dump.
...
{
/*
Vanilla shader code from 0x49E8BE54:
  float4 r0,r1,r2,r3;
*/
...
// RenoDX code: Inject the addon constants and replacement logic.
  ...
  r0.y = r0.y * r0.x;
  r0.z = cmp(2.000000 == cb3[0].y);
  r1.xyz = r0.zzz ? r1.xyz : r2.xzw;
  r0.z = dot(r1.xyz, float3(0.212672904,0.715152204,0.0721750036));
  r2.xzw = r1.xyz + -r0.zzz;
  r2.xzw = cb1[104].www * r2.xzw + r0.zzz;
  r2.xzw = cb1[104].xyz * r2.xzw;
  r0.z = -cb3[2].w + 1;
  r1.xyz = r1.xyz * r0.zzz;
  o0.xyz = r2.xzw * cb3[2].www + r1.xyz;
  r0.z = max(0, r2.y);
  r0.w = r0.x * r2.y;
  o0.w = r0.x * r0.z;
  r0.x = max(r0.y, r0.w);
