// DX11 shader 0xC28DD074, decompiled from the matching 1.4.4 game shader dump.
...
void main(uint3 vThreadID : SV_DispatchThreadID)
{
  ...
  r0.w = r2.x / r0.w;
/*
Vanilla shader code from 0xC28DD074:
