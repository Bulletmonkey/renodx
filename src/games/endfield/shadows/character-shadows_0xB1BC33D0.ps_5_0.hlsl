  ...
  out float3 o0 : SV_Target0)
{
  ...
  r0.z = cmp(cb3[35].w < 0.99000001);
  if (r0.z != 0) {
    r0.z = (int)cb3[35].x;
    r0.w = cmp((int)r0.z == 2);
    r4.xyz = r0.www ? cb3[20].xyz : cb0[44].xyz;
    r4.xyz = -r4.xyz + r2.xyz;
    r0.w = dot(r4.xyz, r4.xyz);
    r0.w = cb3[34].w + -r0.w;
    r0.w = saturate(cb3[34].z * r0.w);
    r0.w = max(cb3[36].x, r0.w);
    r2.w = cmp(0 < r0.w);
    if (r2.w != 0) {
      r0.z = cmp(0 < (int)r0.z);
      if (r0.z != 0) {
        r4.xyz = -cb3[20].xyz + r2.xyz;
        r5.xyz = -cb3[21].xyz + r2.xyz;
        r6.xyz = -cb3[22].xyz + r2.xyz;
        r7.xyz = -cb3[23].xyz + r2.xyz;
        r0.z = dot(r4.xyz, r4.xyz);
        r2.w = dot(r5.xyz, r5.xyz);
        r3.w = dot(r6.xyz, r6.xyz);
        r4.x = dot(r7.xyz, r7.xyz);
        r5.x = cmp(r0.z < cb3[20].w);
        r5.y = cmp(r2.w < cb3[21].w);
        r5.z = cmp(r3.w < cb3[22].w);
        r5.w = cmp(r4.x < cb3[23].w);
        ...
        r0.z = max(0, r0.z);
        r0.z = min(3, r0.z);
        r0.z = max(cb3[34].y, r0.z);
        r2.w = (uint)r0.z;
        r2.w = (uint)r2.w << 2;
        r4.xyz = cb3[r2.w+1].xyz * r2.yyy;
        r4.xyz = cb3[r2.w+0].xyz * r2.xxx + r4.xyz;
        r4.xyz = cb3[r2.w+2].xyz * r2.zzz + r4.xyz;
        ...
        r0.z = (int)r0.z;
        r4.xy = r4.xy * cb3[r0.z+28].zw + cb3[r0.z+28].xy;
        r6.xy = r4.xy * cb3[32].zw + float2(0.5,0.5);
        r6.xy = floor(r6.xy);
        r4.xy = r4.xy * cb3[32].zw + -r6.xy;
        ...
        r7.xy = cb3[32].xx * r4.xy;
        r4.xy = r8.yw / r10.yw;
        r4.xy = float2(-1.5,0.5) + r4.xy;
        r7.zw = cb3[32].yy * r4.xy;
        r8.xyzw = r10.xyzw * r9.xyzw;
        r9.xyzw = r6.xyxy * cb3[32].xyxy + r7.xzyz;
        r0.z = t1.SampleCmpLevelZero(s3_s, r9.xy, r4.z).x;
        r2.w = t1.SampleCmpLevelZero(s3_s, r9.zw, r4.z).x;
        r2.w = r8.y * r2.w;
        r0.z = r8.x * r0.z + r2.w;
        r6.xyzw = r6.xyxy * cb3[32].xyxy + r7.xwyw;
    ...
    r0.z = cmp(r0.w < 1);
    r2.w = cmp(0.5 < cb3[36].x);
    r0.z = (int)r0.z | (int)r2.w;
    if (r0.z != 0) {
      r0.z = dot(r3.xyz, cb2[0].xyz);
      r0.z = max(0, r0.z);
      r0.z = min(0.899999976, r0.z);
      r0.z = 1 + -r0.z;
      r4.xy = cb3[584].xy * r0.zz;
      r4.xzw = -cb2[0].xyz * r4.xxx + r2.xyz;
      r4.xyz = r3.xyz * r4.yyy + r4.xzw;
      r6.xy = cb3[581].xy * r4.yy;
      r6.xy = cb3[580].xy * r4.xx + r6.xy;
      r6.xy = cb3[582].xy * r4.zz + r6.xy;
      r6.xy = cb3[583].xy + r6.xy;
      ...
      if (r0.z != 0) {
        ...
        r2.w = 0x0000ffff & asint(cb3[r0.z+587].x);
        r6.x = f16tof32(r2.w);
        r2.w = cmp(r6.x >= 0);
        if (r2.w != 0) {
          r7.x = cb3[576].x;
          ...
          r3.w = r3.w ? r4.x : 0;
          if (r3.w != 0) {
            r0.z = asuint(cb3[r0.z+587].x) >> 16;
            r6.y = f16tof32(r0.z);
            r4.xy = r7.xy * cb3[584].zw + r6.xy;
            r4.zw = r4.xy * cb3[586].zw + float2(0.5,0.5);
            r4.zw = floor(r4.zw);
            r4.xy = r4.xy * cb3[586].zw + -r4.zw;
            ...
            r4.xy = r9.yw / r7.zw;
            r4.xy = float2(-1.5,0.5) + r4.xy;
            r9.xy = cb3[586].xx * r4.xy;
            r4.xy = r6.yw / r8.yw;
            r4.xy = float2(-1.5,0.5) + r4.xy;
            r9.zw = cb3[586].yy * r4.xy;
            r6.xyzw = r8.xyzw * r7.xyzw;
            r7.xyzw = r4.zwzw * cb3[586].xyxy + r9.xzyz;
            r0.z = t4.SampleCmpLevelZero(s3_s, r7.xy, r2.w).x;
            r3.w = t4.SampleCmpLevelZero(s3_s, r7.zw, r2.w).x;
            r3.w = r6.y * r3.w;
            r0.z = r6.x * r0.z + r3.w;
            r4.xyzw = r4.zwzw * cb3[586].xyxy + r9.xwyw;
    ...
    if (r0.w != 0) {
      r4.xyz = -cb1[93].xyz + r2.xyz;
      r4.yw = cb1[96].xz * r4.yy + r4.xz;
      r5.xy = cb1[94].zz * r4.yw;
      r5.zw = cb1[103].ww * cb1[95].xy;
      r4.yw = r4.yw * cb1[94].zz + r5.zw;
      r0.w = t3.SampleLevel(s2_s, r4.yw, 0).x;
      r4.yw = r5.xy * cb1[95].ww + r5.zw;
      r2.w = t3.SampleLevel(s2_s, r4.yw, 0).x;
      r3.w = dot(r4.xz, r4.xz);
      r3.w = sqrt(r3.w);
      r4.x = cb1[94].y + -cb1[94].x;
      r3.w = -cb1[94].x + r3.w;
      r4.x = 1 / r4.x;
  ...
  if (r0.w != 0) {
    ...
    r0.w = -1 + r0.w;
    r0.w = cb1[95].z * r0.w + 1;
    r0.z *= lerp(1.0, r0.w, saturate(FAKE_CLOUD_SHADOWS));
    }
    r0.w = cb3[35].z + -r0.z;
    r0.z = cb3[35].w * r0.w + r0.z;
  } else {
    r0.z = cb3[35].z;
  }
  ...
  r0.w = -8 + r0.w;
  r1.x = cmp(r0.w >= 0);
  r1.y = cmp(r0.w < cb3[554].z);
  r1.x = r1.y ? r1.x : 0;
  if (r1.x != 0) {
    r0.w = (int)r0.w;
    r1.x = dot(r3.xyz, cb3[r0.w+523].xyz);
    r1.x = max(0, r1.x);
    r1.x = min(0.899999976, r1.x);
    r1.x = 1 + -r1.x;
    r1.y = (uint)r0.w << 2;
    r1.xz = cb3[r0.w+508].xy * r1.xx;
    r2.xyz = -cb3[r0.w+523].xyz * r1.xxx + r2.xyz;
    r1.xzw = r3.xyz * r1.zzz + r2.xyz;
    r2.xyz = cb3[r1.y+449].xyz * r1.zzz;
    r2.xyz = cb3[r1.y+448].xyz * r1.xxx + r2.xyz;
    r1.xzw = cb3[r1.y+450].xyz * r1.www + r2.xyz;
    r1.xyz = cb3[r1.y+451].xyz + r1.xzw;
    ...
    if (r1.w == 0) {
      r2.x = cb3[553].x * 4;
      r1.xy = r1.xy * cb3[r0.w+538].zw + cb3[r0.w+538].xy;
