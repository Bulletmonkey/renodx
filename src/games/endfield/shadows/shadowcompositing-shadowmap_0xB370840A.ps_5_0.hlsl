  ...
  out float3 o0 : SV_Target0)
{
  ...
  r0.x = cmp(cb3[35].w < 0.99000001);
  if (r0.x != 0) {
    r0.xy = (uint2)v0.xy;
    r0.zw = (uint2)r0.xy;
    r1.xy = cb1[0].zw * r0.zw;
    ...
    r1.z = (int)cb3[35].x;
    r1.w = cmp((int)r1.z == 2);
    r3.xyz = r1.www ? cb3[20].xyz : cb0[44].xyz;
    r3.xyz = -r3.xyz + r2.xyz;
    r1.w = dot(r3.xyz, r3.xyz);
    r1.w = cb3[34].w + -r1.w;
    r1.w = saturate(cb3[34].z * r1.w);
    r1.w = max(cb3[36].x, r1.w);
    r2.w = cmp(0 < r1.w);
    if (r2.w != 0) {
      r1.z = cmp(0 < (int)r1.z);
      if (r1.z != 0) {
        r1.xy = t5.SampleLevel(s1_s, r1.xy, 0).xy;
        r3.xyz = -cb3[20].xyz + r2.xyz;
        r4.xyz = -cb3[21].xyz + r2.xyz;
        r5.xyz = -cb3[22].xyz + r2.xyz;
        r6.xyz = -cb3[23].xyz + r2.xyz;
        r3.x = dot(r3.xyz, r3.xyz);
        r3.y = dot(r4.xyz, r4.xyz);
        r3.z = dot(r5.xyz, r5.xyz);
        r3.w = dot(r6.xyz, r6.xyz);
        r4.x = cmp(r3.x < cb3[20].w);
        r4.y = cmp(r3.y < cb3[21].w);
        r4.z = cmp(r3.z < cb3[22].w);
        r4.w = cmp(r3.w < cb3[23].w);
        ...
        r1.z = dot(r5.xyzw, float4(4,3,2,1));
        r1.z = 4 + -r1.z;
        r1.z = max(0, r1.z);
        r1.z = min(3, r1.z);
        r2.w = 1 + r1.z;
        ...
        if (r2.w != 0) {
          r2.w = (uint)r1.z;
          r4.xy = float2(2.08299994,4.8670001) + r0.zw;
          r4.x = dot(r4.xy, float2(0.0671105608,0.00583714992));
          r4.x = frac(r4.x);
          r4.x = 52.9829178 * r4.x;
          r4.x = frac(r4.x);
          r3.x = dot(r3.xyzw, icb[r2.w+0].xyzw);
          r2.w = r3.x / cb3[r2.w+20].w;
          r2.w = sqrt(r2.w);
        ...
        r1.x = r1.x * r1.y;
        r1.x = 4 * r1.x;
        r3.xyz = -cb2[0].xyz * r1.xxx + r2.xyz;
        r4.xyz = cb3[r2.w+1].xyz * r3.yyy;
        r3.xyw = cb3[r2.w+0].xyz * r3.xxx + r4.xyz;
        r3.xyz = cb3[r2.w+2].xyz * r3.zzz + r3.xyw;
        r3.xyz = cb3[r2.w+3].xyz + r3.xyz;
        r4.xyz = cmp(float3(0,0,0) >= r3.xyz);
        r5.xyz = cmp(r3.xyz >= float3(1,1,1));
        r4.xyz = (int3)r4.xyz | (int3)r5.xyz;
        r1.x = (int)r4.y | (int)r4.x;
        r1.x = (int)r4.z | (int)r1.x;
        r1.y = (int)r3.z & 0x7fffffff;
        r1.y = cmp(0x7f800000 < (uint)r1.y);
        r4.z = (int)r1.y | (int)r1.x;
        r0.zw = float2(0.25,0.25) * r0.zw;
        r5.xy = (int2)r0.zw;
        r5.zw = float2(0,0);
        r4.x = t3.Load(r5.xyz).x;
        r0.z = cmp(r4.x < 0.00100000005);
        r0.w = cmp(0.99000001 < r4.x);
        r0.z = (int)r0.w | (int)r0.z;
        if (r0.z == 0) {
          r0.z = (int)r1.z;
          r1.xy = r3.xy * cb3[r0.z+28].zw + cb3[r0.z+28].xy;
          ...
          r0.y = dot(cb3[33].xyzw, icb[r0.z+0].xyzw);
          ...
          */
          // RenoDX code: Blend the per-cascade PCF radius continuously with shadow hardening.
          r0.y *= lerp(
              1.0,
              lerp(0.75, 1.5, saturate((float)r0.z / 3.0)),
              saturate(SHADOW_HARDENING));
          ...
          while (true) {
            ...
            if (r2.w != 0) break;
            r5.x = dot(icb[r1.z+4].zw, r0.zw);
            r5.y = dot(icb[r1.z+4].wz, icb[r0.x+4].xy);
            r5.xy = r5.xy * r0.yy + r1.xy;
            r5.xyzw = t1.Gather(s1_s, r5.xy).xyzw;
            r5.xyzw = r5.xyzw + -r3.zzzz;
            r6.xyzw = cmp(r5.xyzw >= float4(0,0,0,0));
            r6.xyzw = r6.xyzw ? float4(1,1,1,1) : 0;
            r2.w = dot(r5.xyzw, r6.xyzw);
            r5.x = r3.x + r2.w;
            r2.w = dot(r6.xyzw, float4(1,1,1,1));
            r5.y = r3.y + r2.w;
            r2.w = (int)r1.z + 1;
            r3.xy = r5.xy;
            r1.z = r2.w;
    ...
    r0.x = cmp(r1.w < 1);
    r0.y = cmp(0.5 < cb3[36].x);
    r0.x = (int)r0.y | (int)r0.x;
    if (r0.x != 0) {
      r0.xyz = ddy_coarse(r2.zxy);
      r1.xyz = ddx_coarse(r2.yzx);
      r3.xyz = r1.xyz * r0.xyz;
      r0.xyz = r0.zxy * r1.yzx + -r3.xyz;
      ...
      r0.w = 1 + -r0.w;
      r1.xy = cb3[584].xy * r0.ww;
      r3.xyz = -cb2[0].xyz * r1.xxx + r2.xyz;
      r0.xyz = r0.xyz * r1.yyy + r3.xyz;
      r1.xy = cb3[581].xy * r0.yy;
      r1.xy = cb3[580].xy * r0.xx + r1.xy;
      r1.xy = cb3[582].xy * r0.zz + r1.xy;
      r1.xy = cb3[583].xy + r1.xy;
      ...
      if (r1.z != 0) {
        ...
        r1.y = 0x0000ffff & asint(cb3[r1.x+587].x);
        r3.x = f16tof32(r1.y);
        r1.y = cmp(r3.x >= 0);
        if (r1.y != 0) {
          r5.x = cb3[576].x;
          ...
          r0.yz = cmp(float2(0,0) < r5.xy);
          r0.w = cmp(0 < r0.x);
          r0.y = r0.z ? r0.y : 0;
          r0.y = r0.w ? r0.y : 0;
          r0.zw = cmp(r5.xy < float2(1,1));
          r1.y = cmp(r0.x < 1);
          r0.z = r0.w ? r0.z : 0;
          r0.z = r1.y ? r0.z : 0;
          r0.y = r0.z ? r0.y : 0;
          if (r0.y != 0) {
            r0.y = asuint(cb3[r1.x+587].x) >> 16;
            r3.y = f16tof32(r0.y);
            r0.yz = r5.xy * cb3[584].zw + r3.xy;
            r1.xy = r0.yz * cb3[586].zw + float2(0.5,0.5);
            r1.xy = floor(r1.xy);
            r0.yz = r0.yz * cb3[586].zw + -r1.xy;
            r3.xyzw = float4(0.5,1,0.5,1) + r0.yyzz;
            r5.xw = r3.xz * r3.xz;
            r3.xz = min(float2(0,0), r0.yz);
            r6.xy = max(float2(0,0), r0.yz);
            r6.zw = r5.xw * float2(0.5,0.5) + -r0.yz;
            ...
            r5.y = r0.z;
            r5.z = r3.y;
            r3.xyzw = float4(0.444440007,0.444440007,0.444440007,0.222220004) * r5.xyzw;
            r5.xyzw = r7.xzxz + r7.ywyw;
            r6.xyzw = r3.xxzz + r3.yyww;
            r0.yz = r7.yw / r5.zw;
            r0.yz = float2(-1.5,0.5) + r0.yz;
            r7.xy = cb3[586].xx * r0.yz;
            r0.yz = r3.yw / r6.yw;
            r0.yz = float2(-1.5,0.5) + r0.yz;
            r7.zw = cb3[586].yy * r0.yz;
            r3.xyzw = r6.xyzw * r5.xyzw;
            r5.xyzw = r1.xyxy * cb3[586].xyxy + r7.xzyz;
            r0.y = t4.SampleCmpLevelZero(s3_s, r5.xy, r0.x).x;
            r0.z = t4.SampleCmpLevelZero(s3_s, r5.zw, r0.x).x;
            r0.z = r3.y * r0.z;
            r0.y = r3.x * r0.y + r0.z;
            r5.xyzw = r1.xyxy * cb3[586].xyxy + r7.xwyw;
            r0.z = t4.SampleCmpLevelZero(s3_s, r5.xy, r0.x).x;
            r0.y = r3.z * r0.z + r0.y;
            r0.x = t4.SampleCmpLevelZero(s3_s, r5.zw, r0.x).x;
            r4.y = r3.w * r0.x + r0.y;
          } else {
            r4.y = 1;
          }
    ...
    if (r0.y != 0) {
      r0.yzw = -cb1[93].xyz + r2.xyz;
      r1.xy = cb1[96].xz * r0.zz + r0.yw;
      r1.zw = cb1[94].zz * r1.xy;
      r2.xy = cb1[103].ww * cb1[95].xy;
      r1.xy = r1.xy * cb1[94].zz + r2.xy;
      r0.z = t2.SampleLevel(s2_s, r1.xy, 0).x;
      r1.xy = r1.zw * cb1[95].ww + r2.xy;
      r1.x = t2.SampleLevel(s2_s, r1.xy, 0).x;
      r0.y = dot(r0.yw, r0.yw);
      r0.y = sqrt(r0.y);
      r0.w = cb1[94].y + -cb1[94].x;
      r0.y = -cb1[94].x + r0.y;
      r0.w = 1 / r0.w;
      ...
      r0.y = r0.y * r0.w + r0.z;
      r0.y = -1 + r0.y;
      r0.y = cb1[95].z * r0.y + 1;
      r0.x = r0.x * r0.y;
      }
    }
    */
    // RenoDX code: Blend the vanilla cloud mask continuously with the user control.
    r0.y = cmp(0.00100000005 < r0.x);
  if (r0.y != 0) {
    r0.yzw = -cb1[93].xyz + r2.xyz;
    r1.xy = cb1[96].xz * r0.zz + r0.yw;
    ...
    r0.y = -1 + r0.y;
    r0.y = cb1[95].z * r0.y + 1;
    r0.x *= lerp(1.0, r0.y, saturate(FAKE_CLOUD_SHADOWS));
    }
    r0.y = cb3[35].z + -r0.x;
    r0.x = cb3[35].w * r0.y + r0.x;
  } else {
    r0.x = cb3[35].z;
  }
  r0.x = min(1, r0.x);
  ...
  */
  // RenoDX code: Apply shadow hardening continuously after cloud modulation.
  r0.x = lerp(
      r0.x,
      r0.x * r0.x * (3.0 - 2.0 * r0.x),
      saturate(SHADOW_HARDENING));

  r0.x = -1 + r0.x;
  o0.x = cb3[34].x * r0.x + 1;
  o0.yz = float2(1,0);
  return;
}
