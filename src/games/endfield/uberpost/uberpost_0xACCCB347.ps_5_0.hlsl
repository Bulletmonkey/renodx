  ...
  out float4 o0 : SV_Target0)
{
  ...
  // RenoDX code: Scale the game base chromatic offset so zero strength is truly neutral.
  ...
  if (r0.z != 0) {
    ...
    */
    // RenoDX code: Scale the game base chromatic offset with the user strength.
  ...
  r5.xzw = t3.SampleLevel(s0_s, v1.xy, 0).xyz;
  ...
  r0.w = -cb1[3].x + r0.w;
  r0.w = r1.x * r0.w + cb1[3].x;
  r1.xyz = float3(-1,-1,-1) + r5.wxz;
