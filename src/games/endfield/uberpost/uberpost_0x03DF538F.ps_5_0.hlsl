// Endfield DX11 1.5: derived from this shader's own 0x03DF538F dump.
#include "../shared.h"
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  /* Native 0x03DF538F: LUT shaper, lookup, sRGB output and fixed dither replaced below.
  ...
  r2.y = 0;
  r0.yz = r2.xy + r1.xz;
  r1.xyz = t1.SampleLevel(s0_s, r1.xz, 0).xyz;
  r0.yzw = t1.SampleLevel(s0_s, r0.yz, 0).xyz;
