...
renodx::utils::settings::Settings settings = {
    new renodx::utils::settings::Setting{
        ...
        .label = "FPS Unlock",
        .section = "FPS Limit",
        .tooltip = "Sets the game's internal frame-rate target to 9999 and disables VSync while enabled.",
        .labels = {"Off", "On"},
        .tint = kFpsTint,
    },
    fps_limit_setting = new renodx::utils::settings::Setting{
        ...
        .label = "FPS Limit",
        .section = "FPS Limit",
        .tooltip = "Limits rendered FPS while frame generation is off or temporarily paused. Move fully left to turn off.",
        .tint = kFpsTint,
        .min = 0.f,
        .max = 480.f,
        .format = "%.0f FPS",
    ...
    frame_generation_fps_limit_setting = new renodx::utils::settings::Setting{
        ...
        .section = "FPS Limit",
        .tooltip = "Limits actual presented FPS while frame generation is active. Move fully left to turn off.",
        .tint = kFpsTint,
        .min = 0.f,
        .max = 480.f,
        .format = "%.0f FPS",
    ...
    background_fps_limit_setting = new renodx::utils::settings::Setting{
        ...
        .label = "Background",
        .section = "FPS Limit",
        .tooltip = "Limits the game while its window is not in the foreground. Move fully left to turn off.",
        .tint = kFpsTint,
        .min = 0.f,
        .max = 120.f,
        .format = "%.0f FPS",
    ...
    new renodx::utils::settings::Setting{
        ...
        .tooltip = "Runs the game's GTAO at the current output resolution. Changes apply during gameplay.",
        .labels = {"Off", "On"},
        .tint = kVisualTint,
    },
    new renodx::utils::settings::Setting{
        ...
        .section = "Visual Improvements",
        .tooltip = "Preserves scene and UI composition in FP16, then converts once to HDR10 before DLSS-G. Requires the base Endfield RenoDX addon, bundled vulkan-1.dll, and a game restart.",
        .labels = {"Off", "On"},
        .tint = kVisualTint,
    },
    new renodx::utils::settings::Setting{
        ...
        .default_value = 0.f,
        .can_reset = false,
        .label = "Highest Geometry LOD",
        .section = "Visual Improvements",
        .tooltip = "Forces LOD0 through Endfield's render pipeline. This can substantially increase VRAM use and rendering cost.",
        .labels = {"Off", "On"},
        .tint = kVisualTint,
    },
};
